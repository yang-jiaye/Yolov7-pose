...
def detect(opt):
    ...
    t0 = time.time()
    '''
    Here img im0s are the same thing, define in dataset.py. They are both copy from imgs(list).
    Difference is that im0s is processed img. I don't know why use "im0s" such a confusing name.
    '''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='test2.png', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--project', default='runs_runway/detect', help='save results to project/name')
